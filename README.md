...
#### Core Module (sw::core)
Базовые абстракции и интерфейсы игры.

![Core diagram](docs/uml/core_diagram.svg)

#### Features Module (sw::features)
Конкретные реализации юнитов и действий.

![Features diagram](docs/uml/features_diagram.svg)

#### Complete Class Diagram
Полная диаграмма классов проекта.

![Class diagram](docs/uml/battle_classes.svg)
...
- Часть юнитов обладает способностью перемещения:
  - Они могут перемедститься в любую из восьми прилегающих клеток за ход.
