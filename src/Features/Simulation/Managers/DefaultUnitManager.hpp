...
namespace sw::features
{
	...
	public:
		...
		std::vector<sw::core::Unit*> getUnitsInRadius(const sw::core::Position& center, uint32_t radius) const override;
		std::function<sw::core::Unit*(sw::core::UnitId)> getUnitFunction() const override;
		std::function<std::vector<sw::core::Unit*>(const sw::core::Position&, uint32_t)> getUnitsInRadiusFunction()
			const override;
