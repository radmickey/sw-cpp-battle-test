...
namespace sw::io
{
	...
	public:
		...
		void logUnitMoved(sw::core::UnitId unitId, sw::core::Position pos, uint64_t tick) override
		{
			eventLog.log(tick, UnitMoved{unitId, pos.x, pos.y});
		}
		...
		void logMarchEnded(sw::core::UnitId unitId, sw::core::Position pos, uint64_t tick) override
		{
			eventLog.log(tick, MarchEnded{unitId, pos.x, pos.y});
		}
	};
}
